...
# This is the framework for chaining the Extractors required to do the tripadvisorUK extraction
...
Extractor1 = "85cc9c50-07ac-4b50-b521-63e36ef7bb51" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorUK_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 5900 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.co.uk%2FRestaurants-g186216-oa"+page+"-United_Kingdom.html%23LOCATION_LIST"
...
#now you can open TripAdvisorUK_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorUK (restList) b68d5ff6-65fa-4fc9-8dbd-1da37193a55a
