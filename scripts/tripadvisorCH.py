...
# This is the framework for chaining the Extractors required to do the tripadvisorCH extraction
...
Extractor1 = "c38c7d1f-1060-4ad6-a883-e5cbe05d449c" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorCH_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 2120 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.co.uk%2FRestaurants-g188045-oa"+page+"-Switzerland.html%23LOCATION_LIST"
...
#now you can open TripAdvisorCH_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorCH (restList) 3dc09d12-7d26-432c-ad4c-c9e17230dfc2
