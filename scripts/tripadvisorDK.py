...
# This is the framework for chaining the Extractors required to do the tripadvisorDK extraction
...
Extractor1 = "9c58a40c-dbbc-4bcf-972d-c752aab3bb9c" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorDK_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 280 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.co.uk%2FRestaurants-g189512-oa"+page+"-Denmark.html%23LOCATION_LIST"
...
#now you can open TripAdvisorDK_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorDK (restList) d2e3ec8c-7a81-4d62-aa01-4625632298a8 
