...
# This is the framework for chaining the Extractors required to do the tripadvisorES extraction
...
Extractor1 = "9f3a7e0f-71f3-4427-bb34-89630f9a283a" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorES_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 5100 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.com%2FRestaurants-g187427-oa"+page+"-Spain.html%23LOCATION_LIST"
...
#now you can open TripAdvisorES_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorES (restList) 14645ae4-3f9f-465a-99ab-26b537398832 
