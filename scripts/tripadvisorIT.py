...
# This is the framework for chaining the Extractors required to do the tripadvisorIT extraction
...
Extractor1 = "bae14f3d-7b8a-4aff-a479-22506addfc3b" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorIT_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 8420 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.com%2FRestaurants-g187768-oa"+page+"-Italy.html%23LOCATION_LIST"
...
#now you can open TripAdvisorIT_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorIT (restList) 5f711778-5226-43e9-90a9-54b5094e3589 
