...
# This is the framework for chaining the Extractors required to do the tripadvisorMX extraction
...
Extractor1 = "e42865f7-48ed-4378-a5d2-55697c98784a" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorMX_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 640 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.co.uk%2FRestaurants-g150768-oa"+page+"-Mexico.html%23LOCATION_LIST"
...
#now you can open TripAdvisorMX_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorMX (restList) 35963fa2-e999-48d9-a630-321832b85e7a
