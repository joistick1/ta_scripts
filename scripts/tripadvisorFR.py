...
# This is the framework for chaining the Extractors required to do the tripadvisorIE extraction
...
Extractor1 = "6c206564-e2f5-454a-9b7c-907626da669e" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorFR_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 12640 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.co.uk%2FRestaurants-g187070-oa"+page+"-France.html%23LOCATION_LIST"
...
#now you can open TripAdvisorFR_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorFR (restList) 85d11670-f220-4b70-a4ba-9a1185c936b3 
