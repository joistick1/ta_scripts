...
# This is the framework for chaining the Extractors required to do the tripadvisorPT extraction
...
Extractor1 = "bbc19bcf-7a23-4e6e-b7c3-9d8ae7c0051e" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorPT_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 700 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.com%2FRestaurants-g189100-oa"+page+"-Portugal.html%23LOCATION_LIST"
...
#now you can open TripAdvisorPT_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorPT (restList) 0fade60e-4ced-4fc9-a0b1-4f165cfc7d4c
