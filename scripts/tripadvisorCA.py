...
# This is the framework for chaining the Extractors required to do the tripadvisorCA extraction
...
Extractor1 = "4c6a4028-2486-45ae-9d18-94431ec1bef1" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorCA_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 2280 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.com%2FRestaurants-g153339-oa"+page+"-Canada.html%23LOCATION_LIST"
...
#now you can open TripAdvisorBE_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorCA (restList) b1c05e3d-6356-4e1e-a4c5-c9b8f4c3ff4b 
