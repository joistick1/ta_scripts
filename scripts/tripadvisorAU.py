...
# This is the framework for chaining the Extractors required to do the tripadvisorAU extraction
...
Extractor1 = "53210b65-45ac-4f58-a61f-b0a97e1c7523" #Replace this with the GUID of YOUR Extractors (Locations List)
...
with open('TripAdvisorAU_step1_urls.csv','wb') as f: # if you want to upload URLs directly to the import.io dashboard you can write the results to a .csv file and upload it manually
    writer = csv.writer(f)

    # 1. Get all links generated by Extractor1
    page = 0
    total = 2240 # there are 113 pages with step 20
    page_counter = 1
    error_page = 0
    while page < total:
        ...
        try:
            page = str(page)
            jsonurl = "https://extraction.import.io/query/extractor/"+Extractor1+"?_apikey="+apikey+"&url=https%3A%2F%2Fwww.tripadvisor.co.uk%2FRestaurants-g255055-oa"+page+"-Australia.html%23LOCATION_LIST"
...
#now you can open TripAdvisorAU_step1_urls.csv with generated urls and use all these links for the next extractor in dash - JustEat 2 - TripAdvisorAU (restList) 7f9735a7-f1c1-41d7-aa91-b80be4303c52
